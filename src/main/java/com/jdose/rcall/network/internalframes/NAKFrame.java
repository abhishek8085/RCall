 ...
 */
public class NAKFrame implements SerializableFrame
{
    private NAKFrame(){};
    ...
    public static NAKFrame getNAKFrame( SerializableFrame serializableFrame  )
    {
        return new NAKFrame( serializableFrame.getFrameUUID(), serializableFrame.getSourceMachine(), serializableFrame.getDestinationMachine() );
    }

    private NAKFrame(long uuid, Machine destinationMachine, Machine sourceMachine)
    {
    ...
    {
        return FrameType.NAK_FRAME.getFrameIdentifier();
    }
